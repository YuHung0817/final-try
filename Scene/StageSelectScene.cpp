...
void StageSelectScene::Initialize() {
    ...
    btn = new Engine::ImageButton("stage-select/dirt.png", "stage-select/floor.png", halfW - 200, halfH / 2 + 250+100, 400, 100);
    btn->SetOnClickCallback(std::bind(&StageSelectScene::OurGameOnClick, this));
    AddNewControlObject(btn);
    AddNewObject(new Engine::Label("OUR GAME", "pirulen.ttf", 36, halfW, halfH / 2 + 300+100, 0, 0, 0, 255, 0.5, 0.5));
...
void StageSelectScene::OurGameOnClick() {
